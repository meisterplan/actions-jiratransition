...
const axios_1 = __importStar(__webpack_require__(502));
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const transitionName = (0, core_1.getInput)('transition_name', { required: true });
        const serviceBaseUrl = (0, core_1.getInput)('service_base_url', { required: true });
        const searchPattern = (0, core_1.getInput)('search_pattern', { required: false }) || 'KNUTH-[0-9]+';
        const ignorePattern = (0, core_1.getInput)('ignore_pattern', { required: false }) || 'refs?';
        const commitDepth = parseInt((0, core_1.getInput)('commit_depth', { required: false }) || '10');
        const additionalJql = (0, core_1.getInput)('additional_jql', { required: false }) || "AND status NOT IN ('Ready for Test', 'Ready for Prod-Deploy', 'Closed')";
        const issues = findIssues(searchPattern, ignorePattern, commitDepth);
        if (issues.length === 0) {
            (0, core_1.info)(`Didn't find any issues in git log matching ${searchPattern}.`);
        }
        else {
            ...
            (0, core_1.info)(`${issues.length} issues are matching '${searchPattern}': ${issues.join(', ')}`);
            (0, core_1.info)(`Built jql search pattern: ${jql}`);
            (0, core_1.info)(`Transitioning them to '${transitionName}'...`);
            try {
                yield axios_1.default.get(url);
            }
            catch (e) {
                if (e instanceof axios_1.AxiosError) {
                    (0, core_1.setFailed)(`Failed to execute transitions:\n${(_a = e === null || e === void 0 ? void 0 : e.response) === null || _a === void 0 ? void 0 : _a.data}`);
                }
                else {
                    (0, core_1.setFailed)(`Failed to execute transitions:\n${e}`);
                }
        ...
        (0, core_1.setFailed)(`Failed to transition Jira issues: ${JSON.stringify(err)}`);
    }
});
const findIssues = (searchPattern, ignorePattern, commitDepth) => {
    const commitMessageLines = (0, child_process_1.execSync)(`git log -n ${commitDepth} --no-merges --format=%B`).toString().split('\n');
    const issues = commitMessageLines
...
var form_data = __webpack_require__(939);
...
/* harmony default export */ var helpers_callbackify = (callbackify);
...
var populate = __webpack_require__(718);
